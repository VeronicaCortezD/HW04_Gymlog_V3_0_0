...
public class MainActivity extends AppCompatActivity {
    private static final String MAIN_ACTIVITY_USER_ID =
            "com.example.hw04_gymlog_v300.MAIN_ACTIVITY_USER_ID";
    static final String SHARED_PREFERENCE_USERID_KEY =
            "com.example.hw04_gymlog_v300.SHARED_PREFERENCE_USERID_KEY";
    private static final String SAVED_INSTANCE_STATE_USERID_KEY = "com.example.hw04_gymlog_v300.SAVED_INSTANCE_STATE_USERID_KEY";
    static final String SHARED_PREFERENCE_USERID_VALUE =
            "com.example.hw04_gymlog_v300.SHARED_PREFERENCE_USERID_VALUE";
    ...
    private void loginUser(Bundle savedInstanceState) {
        ...
        // If not found there, check intent
        if(loggedInUserId == LOGGED_OUT){
        ...
        userObserver.observe(this, user -> {
            ...
            if(this.user != null){
                ...
                // TODO: Verify if it is causing an issue
//                logout();
            }
        });
    }
